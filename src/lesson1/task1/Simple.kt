...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double =
    4.445 * ((sagenes * 3 + arshins) * 16 + vershoks) / 100
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg + (min + sec / 60.0) / 60.0) * Math.PI / 180
 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = hypot(x2 - x1, y2 - y1)
