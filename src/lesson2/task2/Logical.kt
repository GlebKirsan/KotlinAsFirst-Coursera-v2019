...
fun queenThreatens(x1: Int, y1: Int, x2: Int, y2: Int): Boolean =
    abs(x2 - x1) == abs(y2 - y1) || x2 - x1 == 0 || y2 - y1 == 0
...
): Boolean = hypot(x2 - x1, y2 - y1) <= r2 - r1 && r1 <= r2

/**
 * Средняя
 *
 * Определить, пройдет ли кирпич со сторонами а, b, c сквозь прямоугольное отверстие в стене со
...
fun brickPasses(a: Int, b: Int, c: Int, r: Int, s: Int): Boolean {
    ...
    return midSide <= max(r, s) && minSide <= min(r, s)
}
